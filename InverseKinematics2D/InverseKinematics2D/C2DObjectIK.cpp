...
{
	std::vector<C2DVector> lines{ {0.f, 0.f}, {0.f, 100.f} };
	...
	RootBonePtr->SetPosition({ 0.f, 100.f });
	...
	object0Ptr->SetPosition({ 0.f, 100.f });
	...
	object1Ptr->SetPosition({ 0.f, 100.f });
	...
	object2Ptr->SetPosition({ 0.f, 100.f });
