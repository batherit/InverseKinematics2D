...
void C2DCamera::TransformView(C2DMatrix* outM, C2DMatrix* inM) const
{
	CVectorOperation::C2DTransform(outM, inM, &m_mtxView);
}

void C2DCamera::TransformView(C2DVector* outV, C2DVector* inV) const
{
	CVectorOperation::C2DTransform(outV, inV, &m_mtxView);
}

void C2DCamera::TransformScale(C2DMatrix* outM, C2DMatrix* inM) const
{
	CVectorOperation::C2DTransform(outM, inM, &m_mtxScale);
}

void C2DCamera::TransformScale(C2DVector* outV, C2DVector* inV) const
{
	CVectorOperation::C2DTransform(outV, inV, &m_mtxScale);
}

void C2DCamera::TransformProj(C2DMatrix* outM, C2DMatrix* inM) const
{
	CVectorOperation::C2DTransform(outM, inM, &m_mtxProj);
}

void C2DCamera::TransformProj(C2DVector* outV, C2DVector* inV) const
{
	CVectorOperation::C2DTransform(outV, inV, &m_mtxProj);
}

void C2DCamera::TransformScreen(C2DMatrix* outM, C2DMatrix* inM) const
{
	CVectorOperation::C2DTransform(outM, inM, &m_mtxScreen);
}

void C2DCamera::TransformScreen(C2DVector* outV, C2DVector* inV) const
{
	CVectorOperation::C2DTransform(outV, inV, &m_mtxScreen);
}

void C2DCamera::TransformRatio(C2DVector* outV, C2DVector* inV) const
{
...
void C2DCamera::Move(const C2DVector& vector)
{
